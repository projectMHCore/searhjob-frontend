...
<head>
    ...
    <meta name="description" content="Увійдіть у свій акаунт SearchJob та знайдіть роботу мрії">
    ...
    <main class="main-content">
        <div class="auth-container">
            <div class="auth-header">
                ...
                <p>Увійдіть у свій акаунт SearchJob</p>
            </div>
            ...
            <form method="POST" action="login_action.php?action=authenticate">
            ...
            <div class="form-links">
                <p>Немає акаунту? <a href="/frontend/register.php">Зареєструватися</a></p>
